define(["require", "exports"], function (require, exports) {
    ...
    var BootstrapCards = (function () {
        function BootstrapCards() {
            ...
            this.lipsum2 = "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus fringilla, quam sit amet commodo efficitur, felis justo sodales arcu, at vulputate nunc mi quis risus. Vestibulum sit amet maximus nunc, in sagittis nunc. Nunc sit amet quam non dui imperdiet malesuada.";
            this.lipsum3 = "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus fringilla, quam sit amet commodo efficitur, felis justo sodales arcu, at vulputate nunc mi quis risus.";
            this.ccnum1 = "4444 3333 2222 1111";
            this.cctypes = {
                visa: /^4/,
                union: /^62/,
                amex: /^(34|37)/,
        ...
        BootstrapCards.prototype.checkNumber = function (evt) {
            if (evt.ctrlKey || evt.altKey || evt.metaKey || evt.charCode === 0)
                return true;
            return /[0-9]/.test(String.fromCharCode(evt.charCode));
        };
        BootstrapCards.prototype.ccnumChange = function () {
            var c = this.ccnum1.replace(/\s/g, '').replace(/\d{4,4}/g, function (t) {
                return t + ' ';
            });
        ...
        return BootstrapCards;
    }());
    exports.BootstrapCards = BootstrapCards;
});
